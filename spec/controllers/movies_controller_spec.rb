...
describe MoviesController do
  ...
  describe "GET index" do
    it "assigns all movieses as @movieses" do
  ...
  describe "GET show" do
    it "assigns the requested movie as @movie" do
      Movie.stub(:get).with("37") { mock_movie }
      get :show, :id => "37"
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested movie" do
        Movie.stub(:get).with("37") { mock_movie }
        mock_movie.should_receive(:update).with({'these' => 'params'})
        put :update, :id => "37", :movie => {'these' => 'params'}
      end

      it "assigns the requested movie as @movie" do
        Movie.stub(:get) { mock_movie(:update => true) }
        put :update, :id => "1"
        assigns(:movie).should be(mock_movie)
      end
    ...
    describe "with invalid params" do
      it "assigns the movie as @movie" do
        Movie.stub(:get) { mock_movie(:update => false) }
        put :update, :id => "1"
        assigns(:movie).should be(mock_movie)
      end
