...
describe PicturesController do
  ...
  describe "GET index" do
    it "assigns all pictureses as @pictureses" do
  ...
  describe "GET show" do
    it "assigns the requested picture as @picture" do
      Picture.stub(:get).with("37") { mock_picture }
      get :show, :id => "37"
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested picture" do
        Picture.stub(:get).with("37") { mock_picture }
        mock_picture.should_receive(:update).with({'these' => 'params'})
        put :update, :id => "37", :picture => {'these' => 'params'}
      end

      it "assigns the requested picture as @picture" do
        Picture.stub(:get) { mock_picture(:update => true) }
        put :update, :id => "1"
        assigns(:picture).should be(mock_picture)
      end
    ...
    describe "with invalid params" do
      it "assigns the picture as @picture" do
        Picture.stub(:get) { mock_picture(:update => false) }
        put :update, :id => "1"
        assigns(:picture).should be(mock_picture)
      end
